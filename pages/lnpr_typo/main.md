...
|場所|訂正事項|発見者|一言|
|:---|:-----|------|:-----|
|p.192 式(8.34)|\\(\approx \hat{m} +\\) \\(\Longrightarrow\\) \\(\approx \boldsymbol{h}(\hat{m}) + \\)|[2255067t-rgb](https://github.com/2255067t-rgb)さんの[スライドへのプルリク](https://github.com/ryuichiueda/LNPR_SLIDES/pull/29) |コードに関係ないところで油断しました|
