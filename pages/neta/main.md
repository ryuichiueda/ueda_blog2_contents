...
* チューリッヒのゲイストリートのゲイホテルに宿泊（注意: 「クソみたいな経験」とするのはどうかと思ったんですが、とりあえずそこにいると、街中のほぼ全員が私をゲイとして扱ってくれていろいろ認識に齟齬が出るという、マジョリティーとマイノリティーの逆転現象が起きたので、性的マイノリティーのみなさんは苦労されているなあと、肌で感じました。もちろん宿泊当時は楽しかったです。）
