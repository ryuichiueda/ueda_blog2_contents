...
|場所|訂正事項|発見者|一言|
|:---|:-----|------|:-----|
|p.56 式(2.94)|積分は不要|上田|\\( \boldsymbol{x}\\)で積分したら\\(p_3\\)が\\(x\\)の関数にならないじゃないか・・・|
