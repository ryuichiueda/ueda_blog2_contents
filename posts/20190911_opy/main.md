...
　ちなみに、`https://snapcraft.io/opy`ではダウンロード数とかも閲覧できるみたいなので楽しみです。これでダウンロードが少ないと、先日のバズりが、`opy`面白い、あるいは使ってみたいではなく、「opyがお○ぱいだ！」という点でのものだったことになり、大変悲しいのでぜひインストールしてみてください。
