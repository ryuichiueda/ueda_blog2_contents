...
&= \dfrac{1}{(N+1)^2} \left\langle (x_1 + x_2 + \dots + x_N - N \mu )^2 + (x_{N+1} - \mu)^2 + 2(x_1 + x_2 + \dots + x_N - N \mu )(x_{N+1} - \mu)  \right\rangle_{p(x)}\\\\
&= \dfrac{1}{(N+1)^2} \Big\langle (x_1 + x_2 + \dots + x_N - N \mu )^2 + (x_{N+1} - \mu)^2 + 2(x_1 + x_2 + \dots + x_N - N \mu )(x_{N+1} - \mu)  \Big\rangle_{p(x)}\\\\
&= 
\end{align}
