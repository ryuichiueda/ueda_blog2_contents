...
　証明については[「高校数学の美しい物語」](https://manabitimes.jp/math/1035)にあり、「[ロボットの確率・統計](https://amzn.to/485rprT)」でも同様のものを書きました。
...
* [「ロボットの確率・統計問題集」](/?page=robot_and_stats_questions#不偏分散の期待値)
