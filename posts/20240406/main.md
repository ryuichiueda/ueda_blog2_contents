...
　ひとつ言えるのは、わたしのシェル芸の活動とかサラリーマン歴とかは、大学での実績にはカウントされないということです。何が言いたいかというと、シェル芸界隈の活動で点数稼ぎをしているわけではないので、子供の遊びにこれからも付き合ってほしいということです。（ちょっとお金は入っりますが。）一応、書籍がカウントされることはありますが、今回は私自身が申告しませんでした。
