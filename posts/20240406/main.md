...
　条件に関して言えることとしては、わたしのシェル芸の活動は、大学での実績にはカウントされないということです。何が言いたいかというと、シェル芸界隈の活動で点数稼ぎをしているわけではないので、遊びにこれからも付き合ってほしいということです。（ちょっとお金は入っりますが。）一応、書籍がカウントされることはありますが、今回は私自身が申告しませんでした。
