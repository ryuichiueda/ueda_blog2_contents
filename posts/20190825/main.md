...
こういう行為というのは界隈へのコントリビューションの量でなんとかなるものではありませんし、コントリビューションの量でさじ加減すると奴隷が偉いみたいになって絶対にダメなので、何があっても個人的にはダメです。さじ加減は「ちゃんと会話できるかどうか」です。それができない人とは、できることなら太陽系の幅くらい距離をとりたいです。無理ですが。
