...
It is clearly unsuitable for oneliner. 
  ...
  However, Python has the list data type. Then AWK also treats fields of each line as an element of a list. So I thought the action of AWK can be replaced to the list operation of Python.
