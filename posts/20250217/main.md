...
くらいに考えてのことです。このふたつになにか心がひかれるなら、乗っかっていただければ幸いです。特にOSかなにかにバンドルされるようになると嬉しいので、もしなんかそういう活動がしたい人はご協力お願いいたします。それから、あとはコードの質問はなるべく返事しますので、Rustの勉強にもご活用ください。また、敷居の低いとっかかりとしては、未実装の部分でもなんでもいいから、issueに「Bashはこう動くけど寿司シェルは違う」と書くのがよろしいかと。
