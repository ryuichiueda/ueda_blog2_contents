...
　SciPyをワンライナーで使ってみよう！！！！１、ということで[opy](https://github.com/ryuichiueda/opy)を使っていろいろ実験しました。シェルの上でこういう計算をやる機会があるかどうかという話があるんですけど、誰にとって何が役にたつかということは分からんので、例を示しておきます。
